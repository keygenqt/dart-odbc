...
class NativeLibrary {
  ...
  late final _TraceOpenLogFilePtr = _lookup<
      ffi.NativeFunction<
          RETCODE Function(
              SQLPOINTER, LPSTR, LPSTR, DWORD)>>('TraceOpenLogFile');
  ...
  late final _SQLSetConnectOptionWPtr = _lookup<
      ffi.NativeFunction<
          SQLRETURN Function(
              SQLHDBC, SQLUSMALLINT, SQLULEN)>>('SQLSetConnectOptionW');
  ...
  late final _SQLSetConnectOptionAPtr = _lookup<
      ffi.NativeFunction<
          SQLRETURN Function(
              SQLHDBC, SQLUSMALLINT, SQLULEN)>>('SQLSetConnectOptionA');
  ...
  late final _SQLSetStmtOptionAPtr = _lookup<
      ffi.NativeFunction<
          SQLRETURN Function(
              SQLHSTMT, SQLUSMALLINT, SQLULEN)>>('SQLSetStmtOptionA');
...
class tagODBC_VS_ARGS extends ffi.Struct {
